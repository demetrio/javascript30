...
// Interpolated
console.log(
  'This is an interpolated console.log. So, hello my name is %s.',
  'Demetrio'
);

// Styled
console.log(
  '%cI am a console.log, but with styles',
  'font-size: 15px; background-color: grey;'
);
...
console.log('================================');
console.log(
  'If you use console.dir(p); you can see all the information about "p"'
);
console.log('================================');
